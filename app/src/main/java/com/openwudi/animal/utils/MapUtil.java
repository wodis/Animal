...
public class MapUtil {
     ...
     * @param trackApp
     */
    public void setCenter(AnimalApplication trackApp) {
    ...
    public void updateStatus(LatLng currentPoint, boolean showMarker) {
        ...
        if (null != baiduMap.getProjection()) {
            ...
            if (screenPoint.y < 200 || screenPoint.y > AnimalApplication.screenHeight - 500
                    || screenPoint.x < 200 || screenPoint.x > AnimalApplication.screenWidth - 200
                    || null == mapStatus) {
