...
public class TimePickerDialog extends DialogFragment implements View.OnClickListener {
    ...
    private static String PICKER_CONFIG_KEY = "picker_config_key";

    private static TimePickerDialog newInstance(PickerConfig pickerConfig) {
        TimePickerDialog timePickerDialog = new TimePickerDialog();
        Bundle bundle = new Bundle();
        bundle.putParcelable(PICKER_CONFIG_KEY, pickerConfig);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            mPickerConfig = bundle.getParcelable(PICKER_CONFIG_KEY);
        }
    ...
    */
    void sureClicked() {
        ...
        if (mPickerConfig.mCallBack != null) {
            ...
            mPickerConfig.mCurrentCalendar = new WheelCalendar(mCurrentMillSeconds);
        }
        dismiss();
    }
